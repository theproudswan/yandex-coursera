...
// ================= End Unit defenition section ======================

// ================= Building defenition section ======================
bool Building::CollideWith(const Unit& that) const {
      return geo2d::Collide(that.p, this->r);
}
bool Building::CollideWith(const Building& that) const {
      return geo2d::Collide(that.r, this->r);
}
bool Building::CollideWith(const Tower& that) const {
      return geo2d::Collide(that.c, this->r);
}
bool Building::CollideWith(const Fence& that) const {
      return geo2d::Collide(that.s, this->r);
}
// ================= End Building defenition section ==================

// ================= Tower defenition section =========================
bool Tower::Collide(const GameObject& that) const {
      return that.CollideWith(*this);
}
bool Tower::CollideWith(const Unit& that) const {
      return geo2d::Collide(that.p, this->c);
}
bool Tower::CollideWith(const Building& that) const {
      return geo2d::Collide(that.r, this->c);
}
bool Tower::CollideWith(const Tower& that) const {
      return geo2d::Collide(that.c, this->c);
}
bool Tower::CollideWith(const Fence& that) const {
      return geo2d::Collide(this->c, that.s);
}
// ================= End Tower defenition section =====================

// ================= Fence defenition section =========================
bool Fence::Collide(const GameObject& that) const {
      return that.CollideWith(*this);
}
bool Fence::CollideWith(const Unit& that) const {
      return geo2d::Collide(that.p, this->s);
}
bool Fence::CollideWith(const Building& that) const {
      return geo2d::Collide(that.r, this->s);
}
bool Fence::CollideWith(const Tower& that) const {
      return geo2d::Collide(that.c, this->s);
}
bool Fence::CollideWith(const Fence& that) const {
      return geo2d::Collide(that.s, this->s);
}
// ================= End Fence defenition section =====================
