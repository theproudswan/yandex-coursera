...
void TestPredefinedLastNameFirst() {
    ...
    person.ChangeLastName(1000, "LastName");
    person.ChangeFirstName(1967, "FirstName");

    AssertEqual(person.GetFullName(1), "Incognito");
    AssertEqual(person.GetFullName(1861), "LastName with unknown first name");
    AssertEqual(person.GetFullName(2001), "FirstName LastName");
}
