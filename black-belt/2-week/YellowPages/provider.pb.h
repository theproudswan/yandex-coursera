...
class Provider final :
 ...
 public:
  ...
  Provider* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline uint32_t Provider::_internal_priority() const {
  return priority_;
}
inline uint32_t Provider::priority() const {
  // @@protoc_insertion_point(field_get:YellowPages.Provider.priority)
  return _internal_priority();
}
inline void Provider::_internal_set_priority(uint32_t value) {
  
  priority_ = value;
}
inline void Provider::set_priority(uint32_t value) {
